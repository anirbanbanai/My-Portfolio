            ...
            <div className='nnn2'>
                ...
                <div data-aos="zoom-in-up" data-aos-duration="1000" className=' n4 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                    <div className='text-center bg-slate-300 p-5 rounded-2xl'>
                        ...
                        <h3>Tailwind</h3><div className="radial-progress text-blue-600" style={{ "--value": 95 }}>95%</div>
                    </div>
                    ...
                    <div className='text-center  bg-slate-300 p-5 rounded-2xl'>
                        ...
                        <div className="radial-progress text-blue-600" style={{ "--value": 90 }}>90%</div>
                    ...
                    <div className='text-center bg-slate-300 p-5 rounded-2xl'>
                        ...
                        <div className="radial-progress text-blue-600" style={{ "--value": 95 }}>95%</div>
                    ...
                    <div className='text-center bg-slate-300 p-5 rounded-2xl'>
                        ...
                        <h3>JavaScript</h3><div className="radial-progress text-blue-600" style={{ "--value": 90 }}>90%</div>
                    </div>
                    <div className='text-center bg-slate-300 p-5 rounded-2xl'>
                        <img className='mx-auto w-16' src={img6} alt="" />
                        <h3>React</h3><div className="radial-progress text-blue-600" style={{ "--value": 90 }}>90%</div>
                    </div>
            ...
            <div className='nnn2'>
                ...
                <div data-aos="zoom-in-up" data-aos-duration="1000" className=' n4 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                    <div className='text-center bg-slate-300 p-5 rounded-2xl'>
                        ...
                        <div className="radial-progress text-blue-600" style={{ "--value": 85 }}>85%</div>
                    </div>
